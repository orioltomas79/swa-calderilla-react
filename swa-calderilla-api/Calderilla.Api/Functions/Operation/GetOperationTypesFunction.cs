    ...
    public class GetOperationTypesFunction
    {
        ...
        public IActionResult GetOperationTypes([HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = ApiEndpoints.GetOperationTypes)] HttpRequest req)
        {
            var listOperationTypes = new List<Domain.OperationType>
            {
                ...
                new() { Id = 17, Name = "Extraescolars" },
                new() { Id = 18, Name = "Farmacia" },
                new() { Id = 19, Name = "Ferreteria" },
                new() { Id = 20, Name = "Fisio" },
                new() { Id = 21, Name = "Formació" },
                new() { Id = 22, Name = "Gasolina" },
                new() { Id = 23, Name = "Gym" },
                new() { Id = 24, Name = "Ingrés Núria" },
                new() { Id = 25, Name = "Ingrés Oriol" },
                new() { Id = 26, Name = "Metge" },
                new() { Id = 27, Name = "Metge Nenes" },
                new() { Id = 28, Name = "Multa" },
                new() { Id = 29, Name = "Netflix" },
                new() { Id = 30, Name = "Neteja/Cangur" },
                new() { Id = 31, Name = "Nomina GFT" },
                new() { Id = 32, Name = "Nutricionista" },
                new() { Id = 33, Name = "Oci" },
                new() { Id = 34, Name = "Padel" },
                new() { Id = 35, Name = "Parking" },
                new() { Id = 36, Name = "Pelu" },
                new() { Id = 37, Name = "Peatges" },
                new() { Id = 38, Name = "Regals" },
                new() { Id = 39, Name = "Renta" },
                new() { Id = 40, Name = "Restaurant" },
                new() { Id = 41, Name = "Roba" },
                new() { Id = 42, Name = "Rocky" },
                new() { Id = 43, Name = "Spotify" },
                new() { Id = 44, Name = "St Leo - Aigua" },
                new() { Id = 45, Name = "St Leo - Comunitat" },
                new() { Id = 46, Name = "St Leo - Coses casa" },
                new() { Id = 47, Name = "St Leo - Hipoteca" },
                new() { Id = 48, Name = "St Leo - Impostos" },
                new() { Id = 49, Name = "St Leo - Llum" },
                new() { Id = 50, Name = "St Leo - Seguro" },
                new() { Id = 51, Name = "Super" },
            };
